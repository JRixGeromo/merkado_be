...
async function main() {
    ...
    const categories = [
        ...
        },
        {
            ...
            description: "Stylish and trendy clothing and accessories for men, women, and children.",
            subcategories: [
                { name: "Men’s Clothing" },
        ...
        {
            name: "Health & Beauty",
            description: "Health, beauty, and personal care products to help you look and feel your best.",
            subcategories: [
                { name: "Skincare" },
                { name: "Haircare" },
        ...
        {
            name: "Baby & Kids",
            description: "Essential products for babies and kids, including clothing, toys, and nursery items.",
            subcategories: [
                { name: "Baby Clothing" },
        ...
        {
            name: "Tools & DIY",
            description: "Tools, materials, and supplies for DIY projects and home improvement.",
            subcategories: [
                { name: "Power Tools" },
                { name: "Hand Tools" },
  ...
  },
  {
    ...
    description: "Explore a world of entertainment, from movies and music to video games and collectibles.",
    subcategories: [
  ...
  },
  {
    ...
    description: "Elegant and stylish jewelry and watches for every occasion, from luxury to everyday wear.",
    subcategories: [
      { name: "Rings" },
      { name: "Necklaces" },
      { name: "Earrings" },
  ...
  {
    name: "Real Estate",
    description: "Properties for sale or rent, including residential, commercial, and industrial options.",
    subcategories: [
  ...
  },
  {
    ...
    description: "Travel essentials, bookings, and services to make every journey seamless and memorable.",
    subcategories: [
  ...
  },
  {
    ...
    description: "Educational resources, courses, and tools for learners of all ages and interests.",
    subcategories: [
      { name: "Online Courses" },
      { name: "Books & eBooks" },
  ...
  },
  {
    ...
    description: "Professional services to support businesses, including marketing, legal, and IT solutions.",
    subcategories: [
  ...
  {
    name: "Arts & Crafts",
    description: "Supplies and tools for creative projects, from painting and drawing to crafting and sewing.",
    subcategories: [
  ...
  },
  {
    ...
    description: "Exclusive luxury items, designer apparel, fine jewelry, and rare collectibles.",
    subcategories: [
  ...
  },
  {
    ...
    description: "Medical supplies, equipment, and services to support health and wellness.",
    subcategories: [
  ...
  },
  {
    ...
    description: "Products and services for personal and property safety, including home security and cybersecurity.",
    subcategories: [
      { name: "Home Security" },
      { name: "Fire Safety" },
  ...
  },
  {
    ...
    description: "Supplies and tools for farming and agriculture, from seeds to animal feed.",
    subcategories: [
      { name: "Seeds & Plants" },
  ...
  },
  {
    ...
    description: "Digital solutions for business and personal use, including software, web development, and IT consulting.",
    subcategories: [
  ...
  },
  {
    ...
    description: "Decor and supplies for seasonal celebrations and holidays throughout the year.",
    subcategories: [
      { name: "Holiday Decor" },
  ...
  },
  {
    ...
    description: "School essentials for students, including backpacks, supplies, and dorm essentials.",
    subcategories: [
      { name: "Backpacks & Bags" },
      { name: "School Supplies" },
      { name: "Lunch Boxes" },
  ...
  },
  {
    ...
    description: "Gear and accessories for outdoor activities like camping, hiking, and cycling.",
    subcategories: [
      { name: "Camping Gear" },
  ...
  {
    name: "Wedding & Bridal",
    description: "Everything needed for weddings, from bridal attire to decor and invitations.",
    subcategories: [
